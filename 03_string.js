...
//function Experssion-storing a function as value

var myName = function (num1, num2) {
  //thise is ananomus function
};
myName(25, 30);

var myName = function (num1, num2) {
  //function Experssion  with return
  var result = num1 * num2;
  return result;
};
var myResult = myName(25, 30);
...
console.log("Concatenation using + Oprator =", result);
...
console.log(greet.replace("Replace substring",("Mor","Eve")));
...
console.log( "slice() with start index ",greet.slice(5));       // it will start 4 to (length-1)
console.log( "slice with negative  start -index ",greet.slice(-5));
console.log( "slice with negative  start -index ",greet.slice(-7,-2));          //end index is always higher than start one 
...
console.log(`First name is: ${firstName} and last name is ${lastName}`);            // string templete with  variable subtitution 
